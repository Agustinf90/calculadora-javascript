...
Vue.component('botonera', {
    ...
    template: `
    <div><div style="display: grid; grid-template-columns: repeat(5, 100px); grid-template-rows: repeat(4, 60px);
    ...
    border-radius: 10px;"v-on:click="action(k)">{{ k }}</button> </div></div>
    </div>`
});
